        ...
        <div className="space-y-6 pt-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full py-3 px-4 bg-slate-800/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-amber-500 transition-colors duration-200"
            />
          </div>
